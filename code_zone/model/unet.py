...
def unet_Enze19_2(pretrained_weights=None, input_size=(256, 256, 1)):
    ...
    up6 = Conv2DTranspose(256, un_conv_size, strides=(2, 2), padding='same', kernel_initializer='he_normal')(conv5)
    merge6 = concatenate([conv4, up6], axis=axis)
    ...
    up7 = Conv2DTranspose(128, un_conv_size, strides=(2, 2), padding='same', kernel_initializer='he_normal')(conv6)
    ...
    up8 = Conv2DTranspose(64, un_conv_size, strides=(2, 2), padding='same', kernel_initializer='he_normal')(conv7)
    ...
    up9 = Conv2DTranspose(32, un_conv_size, strides=(2, 2), padding='same', kernel_initializer='he_normal')(conv8)
